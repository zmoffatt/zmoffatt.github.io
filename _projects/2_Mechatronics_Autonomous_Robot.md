...
<p class="text-center">
{% include button.html link="https://www.youtube.com/watch?v=Uoz3Ah66wBg" text="A video of the robot winning competion (far side of field)" %}
</p>

<p class="text-center">
{% include button.html link="https://www.youtube.com/watch?v=wNWk9Dwdb6A" text="Checkoff attempt video (unsuccessful)" %}
</p>

<p class="text-center">
{% include button.html link="https://www.youtube.com/watch?v=zfO1PEZOL9g" text="Checkoff video (successful)" %}
</p>
